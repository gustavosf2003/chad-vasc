...
>(({ className, ...props }, ref) => {
  return (
    <input
      ...
      ref={ref}
      className={cn(
        "border-1 relative box-border block h-[1.1rem] w-[1.1rem] cursor-pointer appearance-none rounded-md border-[#d9d9d9] bg-slate-200 transition-all duration-300",
        ...
        "after:shadow-[0_0_0_calc(30px_/_2.5)_#ce2772] after:transition-all after:duration-500 after:ease-in after:content-['']",
        "checked:border-transparent checked:bg-[#ce2772]",
        ...
        "hover:border-[#ce2772] focus:outline-[#ce2772]",
